...
console.log(animal1.habitate[0]);
console.log(animal1.getEspecie);
let animal2 = new Animal("mamifero", "vaca", 200, ["terra", "mato", "agua"]);
console.log(animal2);
...
console.log(animal2.habitate[0]);
console.log(animal2.getEspecie);
let animal3 = new Animal("anfibio", "sapo", 0.3, ["agua", "microorganismos", "terra"]);
console.log(animal3);
...
console.log(animal3.habitate[0]);
console.log(animal3.getEspecie);
let fulano = new Aluno("Thiago", 31, [9, 9, 9]);
console.log(fulano);
